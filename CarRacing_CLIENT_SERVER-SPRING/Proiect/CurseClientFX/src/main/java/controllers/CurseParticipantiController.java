...
public class CurseParticipantiController extends UnicastRemoteObject implements ICurseObserver, Serializable {

    public CurseParticipantiController() throws RemoteException{
    }
