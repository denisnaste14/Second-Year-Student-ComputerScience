...
public class MenuMainController {
    ...
    public void OpenWithdraw(MouseEvent mouseEvent) throws Exception{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Views/WithDrawFriendRequest.fxml"));
        Pane root;
        root = loader.load();

        Stage register_stage=new Stage();
        WithdrawFriendRequestController wfrController=loader.getController();
        wfrController.initial(idUserLongged,srv,srvPrietenie,srvMessaj,srvRquest);
        register_stage.setScene(new Scene(root));
        register_stage.show();
    }
    ...
    public void chat(MouseEvent mouseEvent) throws Exception{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/Views/ChooseUserToChat.fxml"));
        Pane root;
        root = loader.load();

        Stage register_stage=new Stage();
        ChooseUserToChatController cutcController=loader.getController();
        cutcController.initial(idUserLongged,srv,srvMessaj);
        register_stage.setScene(new Scene(root));
        register_stage.show();
    }
}
